  ...
  group('Color Opacity Utilities', () {
    ...
    group('applyOpacity', () {
      test('applies 50% opacity', () {
        ...
        final result = applyOpacity(color, 50);
