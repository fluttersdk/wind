...
## 2. The 20 W-widgets at a glance

`fluttersdk_wind` v1 ships 20 widgets, all imported from the single barrel `package:fluttersdk_wind/fluttersdk_wind.dart`. No sub-barrels exist; do not write `import 'package:fluttersdk_wind/widgets.dart'`.
