...
class WindColors {
  static const MaterialColor slate = MaterialColor(_slatePrimaryValue, {
    50: Color(0xfff8fafc),
  ...
  static const MaterialColor neutral = MaterialColor(_neutralPrimaryValue, {
    50: Color(0xfffafafa),
  ...
  static const MaterialColor stone = MaterialColor(_stonePrimaryValue, {
    50: Color(0xfffafaf9),
  ...
  static const MaterialColor lime = MaterialColor(_limePrimaryValue, {
    50: Color(0xfff7fee7),
  ...
  static const MaterialColor emerald = MaterialColor(_emeraldPrimaryValue, {
    50: Color(0xffecfdf5),
  ...
  static const MaterialColor teal = MaterialColor(_tealPrimaryValue, {
    50: Color(0xfff0fdfa),
  ...
  static const MaterialColor cyan = MaterialColor(_cyanPrimaryValue, {
    50: Color(0xffecfeff),
  ...
  static const MaterialColor sky = MaterialColor(_skyPrimaryValue, {
    50: Color(0xfff0f9ff),
  ...
  static const MaterialColor violet = MaterialColor(_violetPrimaryValue, {
    50: Color(0xfff5f3ff),
  ...
  static const MaterialColor fuchsia = MaterialColor(_fuchsiaPrimaryValue, {
    50: Color(0xfffdf4ff),
  ...
  static const MaterialColor rose = MaterialColor(_rosePrimaryValue, {
    50: Color(0xfffff1f2),
  ...
  static const MaterialColor black = MaterialColor(_blackPrimaryValue, {
